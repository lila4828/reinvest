...
def build_analysis_messages(
    ...
    user_prompt = (
        ...
        "- YouTube data may contain guru_opinion. If guru_opinion exists, use it "
        "first for guru_analysis. Use mention_type, sentiment, confidence, "
        "stock_relevance, opinion_impact, buy_upgrade_signal, "
        "price_discipline_note, risk_warning, summary, and evidence_items. "
        "Distinguish DIRECT stock opinion, SECTOR linkage, MARKET linkage, "
        "MINDSET-only guidance, and NONE/insufficient evidence. Do not treat "
        "MINDSET-only content as direct Buy evidence and do not invent YouTube "
        "quotes.\n\n"
        ...
        "- guru_analysis: this is the youtube_analysis section. If guru_opinion "
        "exists, start from mention_type, sentiment, confidence, stock_relevance, "
        ...
        "recommendation for this stock. Do not let buy_upgrade_signal change the "
        "system investment opinion.\n"
