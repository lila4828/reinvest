...
def build_analysis_messages(
    ...
    user_prompt = (
        ...
        "target buy price, and defense price data.\n"
        ...
        "Korean characters, with the final opinion and the strongest evidence-based "
        "reason.\n"
        ...
        "revenue trend, net income trend, FCF quality, debt, margin, valuation, "
        ...
        "downside risks. Explain why the target buy price and defense price matter "
